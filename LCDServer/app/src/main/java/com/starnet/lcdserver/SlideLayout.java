...
public class SlideLayout extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        contentView = findViewById(R.id.text_1);
        deleteView = findViewById(R.id.delete_user);
        modifyView = findViewById(R.id.modify_user);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        menuWidth = deleteView.getMeasuredWidth();
    }

    @Override
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        super.onLayout(changed, left, top, right, bottom);
        deleteView.layout(contentWidth, 0, contentWidth+menuWidth , viewHeight);
        modifyView.layout(contentWidth+menuWidth ,0,contentWidth + 2*menuWidth,viewHeight);
    }
